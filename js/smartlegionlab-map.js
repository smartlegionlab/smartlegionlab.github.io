(function() {
        ...
        function renderHistory() {
            ...
            let html = '';
            const travelerNames = ['Aixandrolab', 'SmartLegionLab', 'You'];
            ...
            travelerNames.forEach((name, idx) => {
                ...
                html += `
                    <div class="accordion-item">
                        ...
                        <div class="accordion-body" id="history_${name}" style="display:${idx === 0 ? 'block' : 'none'};">
        ...
        function createPlanetMesh(color, size, emissiveIntensity = 0.15, hasRing = false) {
            ...
            const atmosGeo = new THREE.SphereGeometry(size * 1.08, 24, 24);
            ...
            if (hasRing) {
                ...
                const ringGeo = new THREE.TorusGeometry(size * 1.6, size * 0.1, 12, 48);
                ...
                const ring2Geo = new THREE.TorusGeometry(size * 1.8, size * 0.05, 12, 48);
        ...
        function createMoon(moonColor, moonSize, planetSize) {
            ...
            if (Math.random() > 0.7) {
                const glowGeo = new THREE.SphereGeometry(finalSize * 1.2, 6, 6);
        ...
        function createTraveler(color, label) {
            ...
            const visorGeo = new THREE.SphereGeometry(0.12, 8, 8);
            const visor = new THREE.Mesh(visorGeo, visorMat);
            visor.position.set(0, 0.35, 0.15);
            visor.scale.set(0.8, 0.7, 0.3);
            group.add(visor);

            const bodyGeo = new THREE.CylinderGeometry(0.15, 0.2, 0.3, 8);
            ...
            const armGeo = new THREE.CylinderGeometry(0.04, 0.04, 0.25, 6);
            ...
            const legGeo = new THREE.CylinderGeometry(0.05, 0.06, 0.2, 6);
        ...
        function buildSolarSystem(graph) {
            ...
            const sunGeo = new THREE.SphereGeometry(2.0, 48, 48);
            ...
            const coronaGeo = new THREE.SphereGeometry(3.5, 24, 24);
                ...
                if (intersects.length > 0) {
                    ...
                    if (obj && obj.userData) {
                        ...
                        clickTimer = setTimeout(() => {
                            const playerShip = ships.find(s => s.userData.isPlayer);
                            if (playerShip && obj.userData.group !== 'root') {
