        ...
        planets: [
            {
                ...
                moons: [
                    ...
                    { label: 'clipassgen', url: 'https://smartlegionlab.com/projects/clipassgen.html' },
                    ...
                    { label: 'babylonian-image-library', url: 'https://smartlegionlab.com/projects/babylonian-image-library.html' },
                    ...
                    { label: 'smart-tsp-oracle', url: 'https://smartlegionlab.com/projects/smart-tsp-oracle.html' },
                    ...
                    { label: 'climan', url: 'https://smartlegionlab.com/projects/climan.html' },
                    { label: 'smart-pch-tsp', url: 'https://smartlegionlab.com/projects/smart-pch-tsp.html' },
                    ...
                    { label: 'smart-text-randomizer', url: 'https://smartlegionlab.com/projects/smart-text-randomizer.html' },
                    { label: 'name-gender-nn-py', url: 'https://smartlegionlab.com/projects/name-gender-nn-py.html' },
                    { label: 'name-gender-nn-rs', url: 'https://smartlegionlab.com/projects/name-gender-nn-rs.html' }
                ]
            },
            {
                name: 'libraries',
            ...
            },
            {
                ...
                moons: [
                    { label: 'Smart Social Network', url: 'https://smartlegionlab.com/projects/smart-social-network.html' },
                    { label: 'Smart Password Manager (Desktop)', url: 'https://smartlegionlab.com/projects/smart-password-manager-desktop.html' },
                    { label: 'Smart Password Manager (Android)', url: 'https://smartlegionlab.com/projects/smart-password-manager-android.html' },
                    { label: 'Smart Password Manager (Web)', url: 'https://smartlegionlab.com/projects/smart-password-manager-web.html' },
                    { label: 'Smart Password Manager (C# Desktop)', url: 'https://smartlegionlab.com/projects/smart-password-manager-csharp-desktop.html' },
                    { label: 'Smart Password Manager (C# CLI)', url: 'https://smartlegionlab.com/projects/smart-password-manager-csharp-cli.html' },
                    { label: 'Smart Password Generator (C# CLI)', url: 'https://smartlegionlab.com/projects/smart-password-generator-csharp-cli.html' },
                    { label: 'Smart Password Generator (C#)', url: 'https://smartlegionlab.com/projects/smart-password-generator.html' },
                    { label: 'CliPassMan', url: 'https://smartlegionlab.com/projects/clipassman.html' },
                    { label: 'CliPassGen', url: 'https://smartlegionlab.com/projects/clipassgen.html' },
                    { label: 'Smart Repository Manager (GUI)', url: 'https://smartlegionlab.com/projects/smart-repository-manager-gui.html' },
                    { label: 'Smart Repository Manager (CLI)', url: 'https://smartlegionlab.com/projects/smart-repository-manager-cli.html' },
                    { label: 'Forgejo Sync Manager (GUI)', url: 'https://smartlegionlab.com/projects/forgejo-sync-manager-gui.html' },
                    { label: 'Forgejo Sync Manager (CLI)', url: 'https://smartlegionlab.com/projects/forgejo-sync-manager-cli.html' },
                    { label: 'Smart 2FA Manager (Desktop)', url: 'https://smartlegionlab.com/projects/smart-2fa-manager-desktop.html' },
                    { label: 'Smart 2FA Manager (Android)', url: 'https://smartlegionlab.com/projects/smart-2fa-manager-android.html' },
                    { label: 'Smart 2FA Manager (CLI)', url: 'https://smartlegionlab.com/projects/smart-2fa-manager-cli.html' },
                    { label: 'Smart 2FA Manager (Bash)', url: 'https://smartlegionlab.com/projects/smart-2fa-manager-bash.html' },
                    { label: 'Smart Project Manager', url: 'https://smartlegionlab.com/projects/smart-project-manager.html' },
                    { label: 'Smart Task Manager', url: 'https://smartlegionlab.com/projects/smart-task-manager.html' },
                    { label: 'Smart File Duplicate Manager (GUI)', url: 'https://smartlegionlab.com/projects/smart-file-duplicate-manager.html' },
                    { label: 'Smart File Duplicate Manager (Rust)', url: 'https://smartlegionlab.com/projects/smart-file-duplicate-manager-rs.html' },
                    { label: 'GitHub Repos Backup Tools', url: 'https://smartlegionlab.com/projects/github-repos-backup-tools.html' },
                    { label: 'GitHub SSH Key Manager', url: 'https://smartlegionlab.com/projects/github-ssh-key.html' },
                    { label: 'TODO App (CLI)', url: 'https://smartlegionlab.com/projects/todo-app-cli.html' },
                    { label: 'Smart Pip Collector', url: 'https://smartlegionlab.com/projects/smart-pip-collector.html' },
                    { label: 'Personal Telegram Bot', url: 'https://smartlegionlab.com/projects/personal-telegram-bot.html' },
                    { label: 'Todo App Telegram Bot', url: 'https://smartlegionlab.com/projects/todo-app-tg-bot.html' },
                    { label: 'Smart ToDo App (Desktop)', url: 'https://smartlegionlab.com/projects/smart-todo-app-desktop.html' },
                    { label: 'Smart ToDo App (Web)', url: 'https://smartlegionlab.com/projects/smart-todo-app-local.html' },
                    { label: 'Smart Bug Tracker', url: 'https://smartlegionlab.com/projects/smart-bug-tracker.html' },
                    { label: 'GitHub Repos Downloader', url: 'https://smartlegionlab.com/projects/github-repos-downloader.html' },
                    { label: 'Smart Guitar Tuner (Android)', url: 'https://smartlegionlab.com/projects/smart-guitar-tuner-android.html' },
                    { label: 'CLI Files Manager', url: 'https://smartlegionlab.com/projects/cli-files-manager.html' },
                    { label: 'CLI ToDo Manager', url: 'https://smartlegionlab.com/projects/cli-todo-manager.html' },
                    { label: 'Simple Social Network', url: 'https://smartlegionlab.com/projects/simple-social-network.html' },
                    { label: 'QR Code Scanner', url: 'https://smartlegionlab.com/projects/qr-code-scanner.html' },
                    { label: 'Android Todo App', url: 'https://smartlegionlab.com/projects/android-todo-app.html' },
                    { label: 'Smart Notebook', url: 'https://smartlegionlab.com/projects/smart-notebook.html' },
                    { label: 'ToDo App (Web)', url: 'https://smartlegionlab.com/projects/todo-app-web-version.html' },
                    { label: 'Get SSH IP Bot', url: 'https://smartlegionlab.com/projects/get-ssh-ip.html' },
                    { label: 'Official TG Bot', url: 'https://smartlegionlab.com/projects/official-tg-bot.html' },
                    { label: 'Calculator', url: 'https://smartlegionlab.com/projects/calculator.html' },
                    { label: 'Snake', url: 'https://smartlegionlab.com/projects/snake.html' },
                    { label: 'GitHub Explorer', url: 'https://smartlegionlab.com/projects/github-explorer.html' },
                    { label: 'GitHubInformer', url: 'https://smartlegionlab.com/projects/githubinformer.html' },
                    { label: 'Web App TG Bot', url: 'https://smartlegionlab.com/projects/web-app-tg-bot.html' },
                    { label: 'QR Codes Gen', url: 'https://smartlegionlab.com/projects/qr-codes-gen.html' },
                    { label: 'OutputDecorator', url: 'https://smartlegionlab.com/projects/outputdecorator.html' },
                    { label: 'GitHub Open Repos Copy Manager', url: 'https://smartlegionlab.com/projects/github-open-repos-copy-manager.html' }
                ]
            },
            {
                name: 'team',
