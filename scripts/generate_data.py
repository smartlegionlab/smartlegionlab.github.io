...
BASE_PAGES = [
    ...
    {'loc': f"{BASE_URL}/ecosystem/smart-passwords-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
    {'loc': f"{BASE_URL}/ecosystem/deterministic-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
    {'loc': f"{BASE_URL}/ecosystem/repository-management-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
    {'loc': f"{BASE_URL}/ecosystem/2fa-management-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
    {'loc': f"{BASE_URL}/ecosystem/np-problem-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
    {'loc': f"{BASE_URL}/ecosystem/research-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
    {'loc': f"{BASE_URL}/ecosystem/todo-ecosystem.html", 'lastmod': '2026-07-01', 'changefreq': 'weekly', 'priority': '0.8'},
